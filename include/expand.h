...
/*   Updated: 2025/09/16 21:16:39 by tmarcos          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						expander_append_string(t_expander *expander,
							const char *str);
...
char					*var_name_alloc(const char *input, size_t start,
							size_t len);
...
int						handle_double_quote_escape(t_expander *expander,
							char next_char);
int						handle_normal_escape(t_expander *expander,
							char next_char);
